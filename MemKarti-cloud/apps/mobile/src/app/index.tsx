...
// DEBUG step 8: stub all lucide icons (return null instead of SVG).
// If screen now renders -> lucide+react-native-svg is the Fabric mount killer.
// import { Sparkles, Users, Plus, LogIn, Trophy, Zap, Wifi } from 'lucide-react-native';
const IconStub = (_: { size?: number; color?: string }) => null;
const Sparkles = IconStub, Users = IconStub, Plus = IconStub;
const LogIn = IconStub, Trophy = IconStub, Zap = IconStub, Wifi = IconStub;
